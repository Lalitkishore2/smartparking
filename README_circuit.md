...
| ⚪ White | Servo Control (Optional) | PWM |
...
F9A70FAB  → Kabilan     (TN-12-GH-3456)
```
...
|---|-----------|----------|--------------|-----------|
| 1 | ESP32 Dev Board | 1 | 500-600 | Amazon, Flipkart |
| 2 | 16x2 LCD Display | 1 | 180-250 | Local Electronics |
| 3 | MG996R Servo Motor | 1 | 350-450 | Amazon |
| 4 | MFRC522 RFID Module | 1 | 250-350 | Amazon |
| 5 | IR Sensor Module | 4 | 100 each | Local Electronics |
| 6 | Red LED | 4 | 5 each | Local Electronics |
| 7 | 220Ω Resistor | 4 | 1 each | Local Electronics |
| 8 | Breadboard (Large) | 1 | 100-150 | Amazon |
| 9 | Jumper Wires Pack | 1 | 50-100 | Amazon |
| 10 | 5V Power Supply | 1 | 200-300 | Local Electronics |
| | **TOTAL** | | **~₹2500-3500** | |
...
- [ESP32 Pinout Reference](https://github.com/AliExpress/ESP32-Pinout)
